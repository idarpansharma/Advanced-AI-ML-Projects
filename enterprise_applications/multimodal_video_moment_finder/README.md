...
```
enterprise_applications/multimodal_video_moment_finder/
├── backend/
...
```bash
cd enterprise_applications/multimodal_video_moment_finder/backend
python -m venv venv
...
```bash
cd enterprise_applications/multimodal_video_moment_finder/frontend
npm install
