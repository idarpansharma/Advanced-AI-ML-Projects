...
This tutorial expects the following files in `rag_implementations/rag_failure_diagnostics_clinic`:
...
From inside `rag_implementations/rag_failure_diagnostics_clinic`:
